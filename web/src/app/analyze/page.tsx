      ...
      <nav className="flex items-center justify-between gap-3 px-6 py-4 lg:px-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col leading-tight">
            <span className="font-display text-base font-bold bg-[linear-gradient(90deg,#FF8FC2,#9670EC,#5EC99F,#E0A93B,#EE5C69,#5FB0EE)] bg-clip-text text-transparent">
              明約 ClariLex
            </span>
      ...
      <div className="grid flex-1 grid-cols-1 gap-4 px-4 pb-8 lg:grid-cols-[300px_1fr_360px] lg:px-8">
        ...
        <aside className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2 max-h-[calc(100vh-360px)] overflow-y-auto pr-1 scrollbar-candy">
            {clauses.length === 0 && (
