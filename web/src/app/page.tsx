...
export default function Home() {
  return (
    <main className="flex flex-col gap-16 px-6 py-10 lg:px-16 lg:py-12">
      {/* Top nav */}
      <nav className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="font-display text-xl font-bold bg-[linear-gradient(90deg,#FF8FC2,#9670EC,#5EC99F,#E0A93B,#EE5C69,#5FB0EE)] bg-clip-text text-transparent">
              明約 ClariLex
            </span>
          </div>
        </div>
      ...
      <section className="flex flex-col items-center gap-8 text-center">
        ...
        <p className="font-mono text-xs uppercase tracking-widest text-candy-mocha lg:text-sm">
          An Intelligent Lease and Sale Legal Document Analysis and Risk Assessment System
      ...
      <footer className="flex flex-col items-center gap-2 pt-12 text-sm text-candy-mocha">
        <div>
          作者：許紫晴（Hsu, Tzu-Ching）｜指導教授：張家瑋 博士（Jia-Wei Chang）、馬豪尚 博士（Hao-Shang Ma）
        </div>
      </footer>
    </main>
  );
